...
import { getBlockByIndex } from "../../src/rpc";

describe("Method getBlockByIndex Tests", () => {
  ...
  it("getBlockByIndex return", async () => {
    ...
    const block = await getBlockByIndex(requestManager, 8);
